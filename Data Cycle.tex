...
To adapt its messages to its different customers, a brand can rely on the data it collects on a daily basis to: 
> Create customer segments, 
> Categorize customers with similar behaviors, 
